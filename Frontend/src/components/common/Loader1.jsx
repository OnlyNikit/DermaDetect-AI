 ...
 *   showText    boolean  show "DermaDetect AI" wordmark + dots (default true)
    ...
    >
      <style>{`
        ...
        .ddai-progress span{
          ...
          background: var(--ddai-teal);
          display:inline-block;
          animation: ddai-bounce 1s ease-in-out infinite;
        }
        .ddai-progress span:nth-child(1){ animation-delay: 0s; }
        .ddai-progress span:nth-child(2){ animation-delay: .15s; background: var(--ddai-navy);}
        .ddai-progress span:nth-child(3){ animation-delay: .3s; }
        @keyframes ddai-bounce{
          0%, 80%, 100% { transform: translateY(0); opacity:.5; }
          40%           { transform: translateY(-6px); opacity:1; }
        }
        @media (prefers-reduced-motion: reduce){
          .ddai-lens-group, .ddai-scan-line, .ddai-dot, .ddai-spark, .ddai-progress span{
      ...
      {showText && (
        <>
          ...
          <div className="ddai-progress" style={{ display: "flex", gap: 6 }}>
            <span />
            <span />
            <span />
          </div>
